...
namespace Bot_Dofus_1._29._1.Comun.Frames.LoginCuenta
{
    ...
    {
        [PaqueteAtributo("HC")]
        public void get_Key_Bienvenida(ClienteLogin cliente, string paquete)
        {
        ...
        [PaqueteAtributo("Ad")]
        public void get_Apodo(ClienteLogin cliente, string paquete) => cliente.cuenta.apodo = paquete.Substring(2);

        [PaqueteAtributo("Af")]
        public void get_Fila_Espera_Login(ClienteLogin cliente, string paquete) => cliente.cuenta.logger.log_informacion("FILA DE ESPERA", "Posición " + paquete[2] + "/" + paquete[4]);

        [PaqueteAtributo("AH")]
        public void get_Servidor_Estado(ClienteLogin cliente, string paquete)
        {
        ...
        [PaqueteAtributo("AxK")]
        public void get_Servidores_Lista(ClienteLogin cliente, string paquete) => cliente.enviar_Paquete(new ListaServidoresMensaje(paquete.Substring(3), cliente.cuenta.servidor_id).get_Mensaje());

        [PaqueteAtributo("AXK")]
        public void get_Seleccion_Servidor(ClienteLogin cliente, string paquete)
        {
