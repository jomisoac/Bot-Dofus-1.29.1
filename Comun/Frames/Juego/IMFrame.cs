...
namespace Bot_Dofus_1._29._1.Comun.Frames.Juego
{
    class IMFrame : Frame
    {
        ...
        public void get_Pelea_Espectador_Activado(TcpClient cliente, string paquete) => cliente.account.Logger.LogInfo("COMBAT", "Le mode Spectator est activé.");
        ...
        public void get_Mensaje_Nueva_Conexion_IP(TcpClient cliente, string paquete) => cliente.account.Logger.LogInfo("DOFUS", "Votre adresse IP actuelle est " + paquete.Substring(3).Split(';')[1]);
