...
namespace Bot_Dofus_1._29._1.Otros.Peleas.Peleadores
{
    public class Luchadores
    {
        ...
        public void get_Actualizar_Luchador(int _id, bool _esta_vivo, int _vida_actual, byte _pa, byte _pm, Cell _celda_id, int _vida_maxima, byte _equipo)
        {
            id = _id;
        ...
        public void get_Actualizar_Luchador(int _id, bool _esta_vivo, int _vida_actual, byte _pa, byte _pm, Cell _celda, int _vida_maxima, byte _equipo, int _id_invocador)
        {
